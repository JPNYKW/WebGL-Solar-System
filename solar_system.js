	...
	function init() {
        ...
        for(let i = 0; i < 9; i++) {
            ...
            let planet_geometry = new THREE.SphereGeometry(size, 120, 120),
				...
				planet_material = new THREE.MeshStandardMaterial({map: planet_texture}),
			...
			planet_stack.push({object: planet_sphere, x, y: 0, z: 0, size, name, texture});
            ...
            if (i == 6) {
                ...
                window.ring_material = new THREE.MeshStandardMaterial({map: ring_texture});
